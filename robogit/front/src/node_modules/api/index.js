...
export const fetchInformationById = async (id) => {
    const {body} = await request.get(
        "http://robogit.org:8080/api/information/by_id/" + id
    );
    return body;
};
...
export const basketToOrder = async () => {
    const {body} = await request.post(
        "http://robogit.org:8080/api/order/create"
    );
    return body;
};
    ...
    switch (filters.activeCategory) {
        case '1':
            body = await request.get(
                'http://robogit.org:8080/api/controller/filter')
        ...
        case '2':
            body = await request.get(
                'http://robogit.org:8080/api/platform/filter')
            .query({min_price: filters.min_price})
            .query({max_price: filters.max_price})
            .query({min_min_voltage: filters.min_min_voltage})
            .query({max_min_voltage: filters.max_min_voltage})
        ...
        case '3':
            body = await request.get(
                'http://robogit.org:8080/api/sensor/filter')
            .query({min_price: filters.min_price})
            .query({max_price: filters.max_price})
            .query({min_min_voltage: filters.min_min_voltage})
            .query({max_min_voltage: filters.max_min_voltage})
        ...
        case '4':
            body = await request.get(
                'http://robogit.org:8080/api/motor/filter')
            .query({min_price: filters.min_price})
            .query({max_price: filters.max_price})
            .query({min_min_voltage: filters.min_min_voltage})
            .query({max_min_voltage: filters.max_min_voltage})
        ...
        case '5':
            body = await request.get(
                'http://robogit.org:8080/api/mechanic_detail/filter')
            .query({min_price: filters.min_price})
            .query({max_price: filters.max_price});
            break;
        case '6':
            body = await request.get(
                'http://robogit.org:8080/api/other/filter')
            .query({min_price: filters.min_price})
            .query({max_price: filters.max_price});
            break;
        default:
            body = await request.get(
                'http://robogit.org:8080/api/information/filter')
                .query({min_price: filters.min_price})
                .query({max_price: filters.max_price});
